...
tar <- "http://www.yes24.com/24/Category/Display/001001025009?ParamSortTp=01&PageNumber=1"
...
for (i in 1:max) {
  ...
  tar_url <- paste0("http://www.yes24.com/24/Category/Display/001001025009?PageNumber=",i)
  print(tar_url)
  read_html(tar_url) %>%
